...
#var _active_phantom_camera_2D: PhantomCamera2D
...
#			_active_phantom_camera_2D.get_position() - _previous_active_phantom_camera_position,
#			tween_duration, \
#			_active_phantom_camera_2D.tween_duration, \
#			_active_phantom_camera_2D.tween_transition,
#			Tween.EASE_IN_OUT
#		)
#	)
...
#			_active_phantom_camera_2D.get_rotation() - _previous_active_phantom_camera_rotation,
#			tween_duration, \
#			_active_phantom_camera_2D.tween_duration, \
#			_active_phantom_camera_2D.tween_transition,
#			Tween.EASE_IN_OUT
...
#
#	_active_phantom_camera_2D = phantom_camera
#	_active_phantom_camera_priority = phantom_camera.get_priority()
#
#	if no_previous_pcam:
#		_previous_active_phantom_camera_position = _active_phantom_camera_2D.get_position()
#		_previous_active_phantom_camera_rotation = _active_phantom_camera_2D.get_rotation()
#
#	tween_duration = 0
#	should_tween = true
#
...
#	if not should_tween:
#		_camera_2D.set_position(_active_phantom_camera_2D.get_position())
#		_camera_2D.set_rotation(_active_phantom_camera_2D.get_rotation())
#	else:
#		if tween_duration < _active_phantom_camera_2D.tween_duration:
#			_move_target(delta)
#		else:
